...
@Component({
  selector: 'app-outstanding-rent',
  templateUrl: './outstanding-rent.component.html',
  styleUrls: ['./outstanding-rent.component.css']
})
export class OutstandingRentComponent implements OnInit {
  public ageingMonths = [
  ...
  ngOnInit() {
    ...
    this.RentForTheMonth = new Date().getMonth() + 1;
