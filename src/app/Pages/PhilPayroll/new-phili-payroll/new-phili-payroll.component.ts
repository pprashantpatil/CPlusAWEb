...
@Component({
  selector: 'app-new-phili-payroll',
  templateUrl: './new-phili-payroll.component.html',
  styleUrls: ['./new-phili-payroll.component.css']
})
export class NewPhiliPayrollComponent implements OnInit {
  PayrollsID: any;
  ...
  ngOnInit() {
    ...
    this.fmsservice.GetStaffByBuildID(74).subscribe(data => {
      debugger
      this.Stafflist = data;
  ...
  public GetStaffDetailsByID(ID) {
    ...
    this.fmsservice.GetStaffDetailsByID(ID).subscribe(
      res => {
        ...
        this.StaffEntity.SSSRate = res[0].deductionPF;
        this.StaffEntity.PagibigRate = res[0].deductionPT;
        this.StaffEntity.PhiliHealth = res[0].deductionTax;
        this.StaffEntity.WithholdingTax = res[0].deductionInsurance;
  ...
  public InsertPhiliPayrolls() {
    ...
    this.fmsservice.InsertPhiliPayrolls(this.StaffEntity).subscribe(res => {
      debugger;
